...
const Statistics = ({ good, neutral, bad, getTotal, getPositive }) => {
    if (getTotal) {
        ...
        <ul className={style.statisticsList}>
            <li className={style.statisticsItem}>Good: <span>{good}</span></li>
            <li className={style.statisticsItem}>Neutral: <span>{neutral}</span></li>
            <li className={style.statisticsItem}>Bad: <span>{bad}</span></li>
        </ul>
        <p>Total {getTotal}</p>
